...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/28 00:33:25 by tjung             #+#    #+#             */
/*   Updated: 2022/03/28 03:56:29 by tjung            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	this->ClapTrap::_hit_points = set;
}

void	ClapTrap::setEnergyPoints(const uint set)
{
	this->ClapTrap::_energy_points = set;
}

void	ClapTrap::setAttackDamage(const uint set)
{
	this->ClapTrap::_attack_damage = set;
}
